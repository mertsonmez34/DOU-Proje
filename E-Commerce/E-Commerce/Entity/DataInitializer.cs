...
namespace E_Commerce.Entity
{
    public class DataInitializer : DropCreateDatabaseIfModelChanges<DataContext>
    {
        protected override void Seed(DataContext context)
        {
            ...
            {
                new Product(){ ProductName = "Iphone 14 Pro",ProductDescription = "iOS 16, Kilit Ekranı’nızı yepyeni ve eğlenceli yollarla kişiselleştirmenize imkan sağlıyor. Daha dikkat çekici olması için fotoğrafınızı öne çıkarın. Aktivite halkalarınızı takip edin. Ve sevdiğiniz uygulamalardan gelen gerçek zamanlı güncellemeleri görün.",PictureURL="https://productimages.hepsiburada.net/s/280/1500/110000267190528.jpg", UnitPrice =1200 , ProductAvailable =true , CategoryID = 1,IsPromoted = true,UnitInStock=true},
                new Product(){ ProductName = "Iphone 14 Pro",ProductDescription = "iOS 16, Kilit Ekranı’nızı yepyeni ve eğlenceli yollarla kişiselleştirmenize imkan sağlıyor. Daha dikkat çekici olması için fotoğrafınızı öne çıkarın. Aktivite halkalarınızı takip edin. Ve sevdiğiniz uygulamalardan gelen gerçek zamanlı güncellemeleri görün.",PictureURL="https://productimages.hepsiburada.net/s/7/550/8914083512370.jpg", UnitPrice =1200 , ProductAvailable =true , CategoryID = 1,IsPromoted = true,UnitInStock=false},
